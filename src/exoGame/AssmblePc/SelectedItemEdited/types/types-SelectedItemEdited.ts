...
import { EventClick_Types } from "../../selectPcProductBox/types/types-SelectPcProductBox";
import React from "react";

export type click_Event_Type = React.MouseEvent<HTMLDivElement>;

export interface Type_AsslbleContiner_ProductArray_Filter
...
export interface SelectedItemEditedProps {
  ...
  >;
  handelAddPcClick: (e: EventClick_Types) => void;
}
